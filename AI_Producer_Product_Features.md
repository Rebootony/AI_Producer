...
## 1. 核心功能 (10 Core Functions / Skills)

基于目前的看板（Overview, Budget, Timeline, Assets）与项目资料（Brief、报价单、执行周期表），AI 制片人（Agent）具备以下 10 项核心功能：
...
10. **`transfer_message` (角色传话与任务派发)**
    ...
    - **场景**: 老板说“催一下张导赶紧交分镜”，AI 会主动向张导（employee）发消息。
